...
def validate_date(is_all_day: bool, date_value: datetime | str, timezone: str | None = None) -> None:
    try:
        ...
        if is_all_day:
            ...
            assert date_value.minute in (0, 15, 30, 45) and date_value.second == 0 and date_value.microsecond == 0
    except ValueError:
