...
class ErrorCode(IntEnum):
    ...
    EVENT_ACCESS_DENIED = 4004

    ML_SERVER_ERROR = 5001
    ML_SERVER_TIMEOUT = 5002

    GOOGLE_CALENDAR_NOT_FOUND = 6001
    GOOGLE_CALENDAR_ALREADY_CONNECTED = 6002
    GOOGLE_CALENDAR_AUTH_FAILED = 6003
    GOOGLE_CALENDAR_TOKEN_INVALID = 6004
    GOOGLE_CALENDAR_TOKEN_EXPIRED = 6005
    GOOGLE_CALENDAR_SYNC_FAILED = 6006
    GOOGLE_CALENDAR_ACCESS_DENIED = 6007
    GOOGLE_OAUTH_FAILED = 6008
    GOOGLE_CALENDAR_NOT_CONNECTED = 6009
    GOOGLE_CALENDAR_DISCONNECT_FAILED = 6010
    FOLLOWEE_CALENDARS_FETCH_FAILED = 6011
